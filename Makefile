...
all: demo random marcels_simple_ga

demo: 	$(OBJECTS) demo.o
	$(CC) $(CXXFLAGS) -o demo demo.o $(OBJECTS)

random: 	$(OBJECTS) random.o
	$(CC) $(CXXFLAGS) -o random random.o $(OBJECTS)

marcels_simple_ga: 	$(OBJECTS) marcels_simple_ga.o
	$(CC) $(CXXFLAGS) -o marcels_simple_ga marcels_simple_ga.o $(OBJECTS)
...
random.o: random.cpp Header.h  Benchmarks.h \
F1.h F2.h F3.h F4.h F5.h F6.h F7.h F8.h F9.h F10.h\
F11.h F12.h F13.h F14.h F15.h 
	$(CC) $(CXXFLAGS) -c random.cpp

marcels_simple_ga.o: marcels_simple_ga.cpp Header.h  Benchmarks.h \
F1.h F2.h F3.h F4.h F5.h F6.h F7.h F8.h F9.h F10.h\
F11.h F12.h F13.h F14.h F15.h
	$(CC) $(CXXFLAGS) -c marcels_simple_ga.cpp
...
.PHONY : clean
clean:
	rm -f demo random marcels_simple_ga $(OBJECTS)
